                        ...
                        <ul class="list-group">
                            ...
                            <?php
                                ...
                                foreach ($trains as $tran_name => $train_number) {
                                    ...
                                    $available_seatType_AndNumber = BD_Rail::DHAKATO_SeatAvailability($train_number, 'SMA', $target_date);
                    ...
                    <div class="col-lg-6 mb-4">
                        <ul class="list-group">
                            ...
                            <?php
                                ...
                                foreach ($trains as $tran_name => $train_number) {
                                    $available_seatType_AndNumber = BD_Rail::DHAKATO_SeatAvailability($train_number, 'ULP', $target_date);
                    ...
                    <div class="col-lg-6 mb-4">
                        <ul class="list-group">
                            ...
                            <?php
                                ...
                                foreach ($trains as $tran_name => $train_number) {
                                    #get seat availability by train number
                                    $available_seatType_AndNumber = BD_Rail::DHAKATO_SeatAvailability($train_number, 'BRBE', $target_date);
                    ...
                    <div class="col-lg-6 mb-4">
                        <ul class="list-group">
                            ...
                            <?php
                                ...
                                foreach ($trains as $tran_name => $train_number) {
                                    #get seat availability by train number
                                    $available_seatType_AndNumber = BD_Rail::DHAKATO_SeatAvailability($train_number, 'CMO', $target_date);
